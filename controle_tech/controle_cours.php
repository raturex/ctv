...
?>
    ...
    WHERE
    etat = 2 or etat = 5 or etat = 6   and /*facturation.date like '$date%' and */immatriculation in ($listfichier)
    ORDER BY
        id_factur
    ASC
        ";
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td width="5%">
                                                                   ...
                                                                   <a class="btn btn-app bg-warning" href="controle_tech_main.php?id_vehic=<?= $row["id"]; ?>&id_factur=<?= $row["id_factur"]; ?>">
