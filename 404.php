          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Erreur Page 404</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      ...
      <section class="content">
        <div class="error-page">
          ...
          <div class="error-content">
            <h3><i class="fas fa-exclamation-triangle text-warning"></i> Oops! Page non trouvé</h3>

            <p>
              Nous n'avons pas trouvé la page que vous recherchez.
              Néanmoins vous pouvez <a href="index.php">retourner à la page d'acceuil</a>
            </p>
