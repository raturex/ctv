                        ...
                        <div class="container-fluid">
                            ...
                            <div class="col-6">
                                ...
                                <div class="card card-warning">
                                    ...
                                    <form name="nClient" action="insert_client.php" method="post">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="form-check">
                                                        ...
                                                        <label class="form-check-label">Recherche par pièce:</label>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    <div class="form-group">
                                                        ...
                                                        <select required class="form-control" name="id_pid" id="inputPid">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input required type="text" class="form-control" id="inputNumPiece" name="num_piece_client" placeholder="numéro de la pièce">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" class="form-control email" id="inputEmailClient" name="email_Client" placeholder="xxx@xx.xx" maxlength="90">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input required type="text" name="nom_client" class="form-control" id="inputNom_client" placeholder="Nom" maxlength="50">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-5">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="inputPnom_client" name="prenom_client" placeholder="Prénoms" maxlength="100">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input required type="date" class="form-control" id="inputdatenaiss" name="datenaiss_client">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-footer">
                                            <button type="submit" value="Submit" class="btn btn-info float-right">suivant</button>
