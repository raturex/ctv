...
if (!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true) {
    ...
    if (isset($_SESSION["role"]) && ($_SESSION["role"] == 2 || $_SESSION["role"] == 1)) {
        ...
        $sql = "SELECT cout(t_to_pay) as sumTopay FROM facturation  WHERE date LIKE '" .$date."%' AND id_caisse = ". $id_user ."";
                ...
                <div class="content-wrapper">
                    ...
                    <section class="content-header">
                        <div class="container-fluid">
                            <div class="row mb-2">
                                <div class="col-sm-6">
                                    <h1>Opération d'enregistrement</h1>
                                </div>
                                <div class="col-sm-6">
                                ...
                                <div class="col-lg-12 col-12">
                                    ...
                                    <a href="client.php" class="small-box-footer">
                                        <div class="small-box bg-lightblue">
                                            <div class="inner">
                                                    <p><strong>Nouvel Enregistrement </strong></p>
                                            </div>
                                            <div class="icon">
                                            ...
                                            <div class="col-md-6 border-right">
                                                ...
                                                <div class="description-block">
                                                    ...
                                                    <?php if ($vehicEnreg["vehicEnreg"] > 1) { ?>
                                                        ...
                                                        <span class="description-text">Véhicules Enregistrés</span>

                                                    <?php } else { ?>
                                                        <h5 class="description-header"><?php echo $vehicEnreg["vehicEnreg"]; ?></h5>
                                                        <span class="description-text">Véhicule Enregistré</span>
                                                    <?php } ?>
                                                ...
                                                <a href="#" class="small-box-footer">
                                                    ...
                                                    <div class="description-block">
                                                        ...
                                                        <?php if ($vehicEnreg2["vehicEnreg2"] > 1) { ?>
                                                            ...
                                                            <span class="description-text">Véhicules Enregistrés aujourd'hui</span>
                                                        <?php } else { ?>
                                                            <h5 class="description-header"><?php echo $vehicEnreg2["vehicEnreg2"]; ?></h5>
                                                            <span class="description-text">Véhicule Enregistré aujourd'hui</span>
                                                        <?php } ?>
