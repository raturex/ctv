                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input required type="text" class="form-control" id="inputNumPiece" name="num_piece_client" placeholder="numero de la pièce">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-group">
                                                    ...
                                                    <input required type="text" class="form-control" id="inputPnom_client" name="prenom_client" placeholder="Prénoms" maxlength="100">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" id="inputdatenaiss" name="datenaiss_client">
                                                </div>
                                            </div>
                                        </div>
