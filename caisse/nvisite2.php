...
?>
                            ...
                            ?>
                                        ...
                                        <form name="nVehicule" action="insert_vehic.php" method="get">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9" class="card-warning card">
                                                    <div class="card-header">
                                                        <h3 class="card-title">
                                                            Véhicule
                                                        </h3>
                                                        ...
                                                        <div class="bs-stepper linear" id="bs_step">
                                                            ...
                                                            <div class="bs-stepper-content">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-6">
                                                                            ...
                                                                            ?>
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" readonly class="form-control" id="id_genre" name="" placeholder="genre" step=1 min=0 readonly value="<?php echo 'Transport de marchandise'; ?>" onchange=CalculVignette() onkeyup=CalculVignette() onload=CalculVignette()>
                                                                            ...
                                                                            ?>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label for="id_genre">Genre</label>
                                                                                    <input type="text" readonly class="form-control" name="" placeholder="genre" step=1 min=0 readonly value="<?php echo 'Transport de personne'; ?>" onchange=CalculVignette() onkeyup=CalculVignette() onload=CalculVignette()>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-sm-6">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="number" class="form-control" id="inputPuisFiscal" name="puiss_fisc" placeholder="Puissance Fiscale" step=1 min=0 readonly value="<?php echo '' . $vign["puiss_fisc"]; ?>" onchange=CalculVignette() onkeyup=CalculVignette() onload=CalculVignette()>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-sm-6">
                                                                                        <div class="icheck-primary d-inline">
                                                                                            <input disabled="disabled" type="checkbox" id="checkTP" name="checkTP" onchange="CalculVignette()" onload=CalculVignette()>
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-sm-6">
                                                                                        <input onchange=CalculVignette() onkeyup=CalculVignette() onload=CalculVignette() type="date" class="form-control" readonly value="<?php echo '' . $vign["date_mise_circul"]; ?>" name="date_mise_circul" id="inputDateMC" placeholder="JJ/MM/AAAA">
                                                                                    </div>
                                                                                    <div class="col-sm-6">
                                                                                        <h5>
                                                                                            <p id="anneeMC"></p>
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input onload=CalculVignette() readonly value="<?php echo '' . $vign["ptac"]; ?>" type="number" class="form-control" id="inputPTAC" name="ptac" onkeyup=CalculVignette() onchange=CalculVignette() step=0.1 min=0>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input readonly value="<?php echo '' . $vign["nb_place"]; ?>"  type="number" class="form-control" id="inputPA" name="nb_place" onchange=CalculVignette() onload=CalculVignette()  onkeyup=CalculVignette() >
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input readonly value="<?php echo '' . $vign["categorie"]; ?>" onchange=CalculVignette() onload=CalculVignette() type="text" class="form-control" id="inputCateg" name="categ" placeholder="Catégorie" onkeyup=CalculVignette()>
                                                                                    </div>
                                                                                </div>
                                                                ...
                                                                <div id="information-part" class="content" role="tabpanel" aria-labelledby="information-part-trigger">
                                                                    ...
                                                                    <input type="hidden" class="form-control" id="prix_vignette" name="prix_vignette" value=0>
        ...
        $sql ="SELECT f.num_facture as Num, f.date as DATE, v.immatriculation as IMMATRICULATION, tc.lib as SERVICE FROM facturation f inner join type_ctrl tc on tc.id=f.id_ctrl inner join vehicule v on v.id = f.id_vehicule WHERE id_vehicule = $id_vehicule order by date desc";
        // On prépare la requête
        $request = $db_PDO->prepare($sql);
        $request = $db_PDO->query($sql);
        // On exécute la requête
        $request->execute();
        // On stocke le résultat dans un tableau associatif
        $list_hist = $request->fetchAll(PDO::FETCH_ASSOC);
                                                ?>
                                                <div class="col-sm-2">
                                                    <div class="card">
                                                        <div class="card-header">
                                                        ...
                                                        <div class="card-body table-responsive p-0" style="height: 300px;">
                                                            <table class="table table-head-fixed text-nowrap">
                                                                ...
                                                                <tbody>
                                                                <?php
                                                foreach ($list_hist as $hist) {
                                                ?>

                                                    <tr>
                                                    <td><?php echo $hist['DATE'] ?> </td>
                                                        <td><?php echo $hist['Num'] ?> </td>
                                                        <td><?php echo $hist['IMMATRICULATION'] ?> </td>
                                                        <td><?php echo $hist['SERVICE'] ?> </td>
