                ...
                <div class="content-wrapper">
                    ...
                    <section class="content">
                        <div class="container-fluid">
                            ...
                            $sql = "SELECT * FROM client LEFT JOIN type_piece on type_piece.id=client.id_piece  WHERE client.id= " . $_GET['id_client'] . " LIMIT 1";
                            ...
                            $email = $client['email'];
                            $date_enreg = $client['date_enr'];

                            $sql = "SELECT COUNT(facturation.id) as nbFact FROM facturation WHERE id_client= $id_client";
                            $request = $db_PDO->prepare($sql);
                            $request = $db_PDO->query($sql);
                            // On exécute la requête
                            $request->execute();
                            // On stocke le résultat dans un tableau associatif
                            $countService = $request->fetch();
                            ?>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-widget widget-user-2 shadow-sm">
                                        ...
                                        <div class="widget-user-header bg-success">
                                            ...
                                            <!-- /.widget-user-image -->
                                            <h3 class="widget-user-username"><?PHP echo $prenoms . " " . $nom ?></h3>
                                            <h6 class="widget-user-desc"><?PHP echo $t_piece . " :  " . $num_piece ?></h6>
                                        </div>
                                        <div class="card-footer p-0">
                                            <ul class="nav flex-column">
                                                <li class="nav-item">
                                                    <a href="#" class="nav-link">
                                                        Véhicule <span class="float-right badge bg-primary"><?PHP echo $client['nb_vehicule'] ?></span>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="#" class="nav-link">
                                                        Service consommé <span class="float-right badge bg-info"><?PHP echo $countService['nbFact'] ?></span>
                                                    </a>
                                                </li>
